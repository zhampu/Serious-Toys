...
// Read the value of the sensor on A0
  ...
  String sensorValy = String((float)event.acceleration.y);
  String sensorVal = String((float)event.acceleration.x);
...
ballDirectionX += event.acceleration.x / 100;
ballDirectionY += event.acceleration.y / 100;
